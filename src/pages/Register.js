...
//   };
//   return (
//     <div className="min-h-screen bg-gray-200 py-6 flex flex-col justify-center items-center sm:py-12 2xl:bg-red-600 xl:bg-green-600">
//       <div className="relative py-1 sm:mx-auto sm:w-6/12 md:w-[38%] lg:w-[40%] xl:w-[25%] 2xl:w-[25%] ">
...
//         <div className="relative px-8 py-6 2xl:px-8 2xl:py-12 bg-white shadow-lg sm:rounded-md sm:p-6">
//           <div className="max-w-md mx-auto">
//             <div className="flex justify-center">
//               {formData.profilePhoto ? (
//                 <img
//                   className="w-16 h-16 md:w-16 md:h-16 lg:w-20 lg:h-20 xl:w-20 xl:h-20  rounded-full border-2 border-sky-300"
//                   src={URL.createObjectURL(formData.profilePhoto)}
//                   alt="Profile Preview"
//                 />
//               ) : (
//                 <FaUserCircle className="w-16 h-16 md:w-16 md:h-16 lg:w-20 lg:h-20 xl:w-20 xl:h-20  rounded-full border-2 border-sky-300" />
//               )}
//             </div>
//             <div>
...
//                     onChange={handleChange}
//                     className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-green-600 text-sm"
//                   />
//                   <label
//                     htmlFor="LastName"
...
//                     className="appearance-none text-[10px] rounded-none relative block w-full px-1 py-1 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
//                   />
//                   {errors.profilePhoto && (
//                     <span className="text-red-400 text-sm">
//                       {errors.profilePhoto}
...
//                   <label
//                     htmlFor="password"
//                     className="absolute left-0 -top-3.5 text-gray-600 text-[5px] peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm"
//                   >
//                     Password
//                   </label>
...
//   return (
//     <div className="flex items-center justify-center min-h-screen bg-gray-200 py-6 sm:py-12">
//       <div className="relative w-full max-w-md mx-auto p-4 sm:p-6 lg:p-8 bg-white shadow-lg rounded-md">
//         <div className="flex justify-center mb-4">
//           {formData.profilePhoto ? (
//             <img
//               className="w-16 h-16 rounded-full border-2 border-sky-300"
//               src={URL.createObjectURL(formData.profilePhoto)}
//               alt="Profile Preview"
//             />
//           ) : (
//             <FaUserCircle className="w-16 h-16 rounded-full border-2 border-sky-300" />
//           )}
//         </div>
...
//               name="profilePhoto"
//               onChange={handlePhotoChange}
//               className="appearance-none text-[10px] rounded-none relative block w-full px-1 py-1 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
//             />
//             {errors.profilePhoto && (
//               <span className="text-red-400 text-sm">{errors.profilePhoto}</span>
//             )}
//           </div>
//           <div className="relative">
//             <input
